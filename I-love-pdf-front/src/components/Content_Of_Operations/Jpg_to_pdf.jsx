  ...
  const uploadFile = async () => {
    ...
    try {
      const res = await axios.post(
        "http://localhost:5147/api/PdfToJpg/images-to-pdf",
        formData,
        { responseType: "blob" }
      );
    ...
    return (
      ...
      >
        <div className={`flex flex-col justify-center items-center p-3  `}>
          ...
          <div className="flex flex-col justify-center items-center p-3">
            <h1 className="font-bold text-[42px] text-[#33333b]">JPG to PDF files</h1>
            <p className="text-[22px] text-gray-700">Convert JPG images to PDF in seconds. Easily adjust orientation and margins.</p>
          </div>
